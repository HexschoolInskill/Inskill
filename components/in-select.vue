<template>
  <in-dropdown v-slot="{ show }" :options="options" size="138px" @select="handleSelect">
    <div
      class="in-select text-fs-6 transition-base inline-flex h-10 min-w-[138px] cursor-pointer items-center justify-between gap-3 rounded-1 border border-solid border-white px-4 text-white"
