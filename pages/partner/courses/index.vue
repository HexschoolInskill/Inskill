<template>
  <div class="flex flex-col bg-gray-900 p-10 text-white">
    ...
    <section class="border-bottom flex w-4/12 flex-col">
      ...
      <input v-model="courseTitle" class="mb-4 rounded border p-1 text-black" type="text" name="title" />

      <label for="subtitle" class="mb-1">課程副標題(選填)</label>
      <input v-model="courseSubtitle" class="mb-4 rounded border p-1 text-black" type="text" name="subtitle" />
