...
<template>
  <div class="flex">
    <div class="main gradient w-9/12 rounded-lg p-4 px-6 max-[1536px]:mt-[4vh]">
...
const { currentCourse, chatRoom } = storeToRefs(useCourses())
const { userProfile } = storeToRefs(useUser())
const { updateChatRoom } = useCourses()
