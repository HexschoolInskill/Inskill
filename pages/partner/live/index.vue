<template>
  <in-container>
    ...
    <div class="flex p-4 text-white">
      <div class="flex w-[170px] border border-b-0 border-l-0 border-t-0">
        <svg
    ...
    <main class="main">
      <!-- mobileTopToolbar -->
      <!-- <div class="mobileTopToolbar hidden">
                <div class="down">
      ...
      <div class="screen" @click="showToolPopup = false">
        <div class="profile text-7xl">
          <video class="h-full w-full" :controls="false" autoplay>
            <source :src="video" type="video/mp4" />
          </video>
        </div>
        <!-- <div class="name left-[15px]">
                    LEOHU
                </div> -->
        <!-- <div class="more right-[15px]">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 128 512"><path d="M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zM120 96A56 56 0 1 0 8 96a56 56 0 1 0 112 0z" fill="#ffffff"/></svg>
                </div> -->
        <div class="smallScreen">
          <div class="h-full w-full">
            <div class="smallProfile text-3xl">
      ...
      <!-- bottom -->
      <div class="mobileBottomTool hidden">
        <div class="item">
          <div class="btnRed">
            <div class="img">
              <svg
        ...
        <div class="item">
          <div class="btnNormal" @click="showToolPopup = true">
            <div class="img">
          ...
          <div class="btnNormal">
            <div class="img">
              ...
              >
                <g fill="none">
                  <path
                    d="M15.5 4C9.149 4 4 9.149 4 15.5V18h7a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H6.5A4.5 4.5 0 0 1 2 25.5v-10C2 8.044 8.044 2 15.5 2S29 8.044 29 15.5v10a4.5 4.5 0 0 1-4.5 4.5H20a1 1 0 0 1-1-1V19a1 1 0 0 1 1-1h7v-2.5C27 9.149 21.851 4 15.5 4z"
                    fill="currentColor"
                  ></path>
                </g>
              </svg>
        ...
        <div class="item">
          ...
          <div v-if="showToolPopup" class="webItemPopup">
            ...
            <div class="popupItem">
              ...
              <div class="text">套用視覺效果</div>
            </div>
            <!-- popupItem -->
            <div class="popupItem bottomPadding">
              <div class="svg">
                <svg xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 576 512">
                  <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                  <path
...
.webRoomName {
  @apply absolute bottom-[20px] left-[20px] text-xl font-bold text-white;
}

.screen {
  @apply my-4 h-[70vh] rounded-lg border border-[#575757de];
  ...
  .smallScreen {
    @apply absolute bottom-[220px] right-[20px] h-[180px] w-[280px] rounded-lg bg-[#6C757D];
  }
...
.webItemPopup {
  @apply absolute top-0 min-h-[40px] w-[260px] translate-x-[-150px] translate-y-[-360px] rounded-sm bg-white px-[15px] pb-0 pt-[15px];
  ...
  .popupItem {
    ...
    .text {
      @apply my-0 ml-[20px] mr-0 font-semibold;
    }
  }
}
...
@media screen and (max-width: 768px) {
  .main {
    @apply w-full px-[10px] py-0;
  }

  .mobileTopToolbar {
    @apply flex w-full items-center justify-start text-sm;
    ...
    .down {
      ...
      .roomName {
        @apply flex w-[60%] items-center justify-start text-white;
        ...
        .icon {
          @apply my-0 ml-[10px] mr-0 px-0 pb-0 pt-[2px];
        }
      }
  ...
  .screen {
    @apply mx-[10%] my-[10%] h-[82vh];
  }

  .mobileBottomTool {
    @apply mx-[10px] mb-[10px] mt-[20px] flex items-center justify-start;
  ...
  .mobileToolpopup {
    @apply absolute top-0 z-[999] block h-screen w-screen bg-[#1f1f1f8f];

    .top {
      @apply h-[55%] w-full bg-[#ffffff00];
    }

    .bottom {
      @apply flex h-[45%] w-full flex-wrap items-center justify-start rounded-sm bg-[#2a2a2a];

      .item {
        @apply w-[33%] px-0 py-[10px] text-center text-xs font-medium text-white;
